    ...
    <div id="center">
      <div id="logo">
        ...
        <div id="social">
          ...
          <a href="https://atcoder.jp/users/miraxial" target="_blank" rel="noopener me"><img src="/atcoder.svg" width="66" height="56" title="atcoder" alt="atcoder" /></a>
        </div>
        <div>
          <a href="https://sv-rikugien.klavier.page">
            <nuxt-img src="/logo.png" alt="sv-rikugien" width="300" height="100" />
          </a>
        </div>
      </div>
      <div id="wrapper">
